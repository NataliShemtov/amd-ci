...
from workflows_amd.amd_gpu_operator_versions.openshift import fetch_ocp_versions, RELEASE_URL_API


class TestOpenShift(unittest.TestCase):
    """Test cases for AMD CI openshift.py functions."""

    @patch('workflows_amd.amd_gpu_operator_versions.openshift.Settings')
    @patch('workflows_amd.amd_gpu_operator_versions.openshift.requests.get')
